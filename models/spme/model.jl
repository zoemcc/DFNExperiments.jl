...
cache_1882722820879189950_n = -589429731.3893579
cache_1882722820879189950_s = -3587155110.512914
cache_1882722820879189950_p = -589429731.3893579
cache_2592574761150854958_n = 
   0.1806862603261852 * x_n

cache_2592574761150854958_s = 
   0.08030500458941565

cache_2592574761150854958_p = 
   (0.007232292579356106 - (0.007232292579356106 * x_p)) / 0.04002679875215723

cache_m1724706607645959773_n = 
   56.212339486148316

cache_m1724706607645959773_s = 0.0
cache_m1724706607645959773_p = 
   -56.212339486148316

cache_486014432791541648_n = 0.3
cache_486014432791541648_s = 1.0
cache_486014432791541648_p = 0.3
cache_2873315888125377410_n = (((Dx_n(((cache_1882722820879189950_n * (D_e(c_e_n(t, x_n) * 1000.0, 298.15))) * Dx_n(c_e_n(t, x_n))) + cache_2592574761150854958_n)) / -0.008035880643729006) + cache_m1724706607645959773_n) / cache_486014432791541648_n
cache_2873315888125377410_s = (((Dx_s(((cache_1882722820879189950_s * (D_e(c_e_s(t, x_s) * 1000.0, 298.15))) * Dx_s(c_e_s(t, x_s))) + cache_2592574761150854958_s)) / -0.008035880643729006) + cache_m1724706607645959773_s) / cache_486014432791541648_s
cache_2873315888125377410_p = (((Dx_p(((cache_1882722820879189950_p * (D_e(c_e_p(t, x_p) * 1000.0, 298.15))) * Dx_p(c_e_p(t, x_p))) + cache_2592574761150854958_p)) / -0.008035880643729006) + cache_m1724706607645959773_p) / cache_486014432791541648_p
eqs = [
   Dt(c_s_n_xav(t, r_n)) ~ cache_m1744780769296494788,
   Dt(c_s_p_xav(t, r_p)) ~ cache_m2497120790061496988,
   Dt(c_e_n(t, x_n)) ~ cache_2873315888125377410_n,
   Dt(c_e_s(t, x_s)) ~ cache_2873315888125377410_s,
   Dt(c_e_p(t, x_p)) ~ cache_2873315888125377410_p,
]
