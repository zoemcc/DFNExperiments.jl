...
cache_m6477020002439104146 = 8.813457647415216 * (1 / r_n^2 * Dr_n(r_n^2 * Dr_n(c_s_n_xav(t, r_n))))

# 'X-averaged positive particle concentration' equation
cache_m6565920499957741508 = 22.598609352346717 * (1 / r_p^2 * Dr_p(r_p^2 * Dr_p(c_s_p_xav(t, r_p))))
...
cache_m336807044546990931_n = -589429731.3893579
cache_m336807044546990931_s = -3587155110.512914
cache_m336807044546990931_p = -589429731.3893579
cache_1468719092292996138_n = 
   0.1806862603261852 * x_n

cache_1468719092292996138_s = 
   0.08030500458941565

cache_1468719092292996138_p = 
   (0.007232292579356106 - (0.007232292579356106 * x_p)) / 0.04002679875215723

cache_8827340298451170061_n = 
   56.212339486148316

cache_8827340298451170061_s = 0.0
cache_8827340298451170061_p = 
   -56.212339486148316

cache_5611008514749088974_n = 0.3
cache_5611008514749088974_s = 1.0
cache_5611008514749088974_p = 0.3
cache_9021953732136320602_n = (((Dx_n(((cache_m336807044546990931_n * (D_e(c_e_n(t, x_n) * 1000.0, 298.15))) * Dx_n(c_e_n(t, x_n))) + cache_1468719092292996138_n)) / -0.008035880643729006) + cache_8827340298451170061_n) / cache_5611008514749088974_n
cache_9021953732136320602_s = (((Dx_s(((cache_m336807044546990931_s * (D_e(c_e_s(t, x_s) * 1000.0, 298.15))) * Dx_s(c_e_s(t, x_s))) + cache_1468719092292996138_s)) / -0.008035880643729006) + cache_8827340298451170061_s) / cache_5611008514749088974_s
cache_9021953732136320602_p = (((Dx_p(((cache_m336807044546990931_p * (D_e(c_e_p(t, x_p) * 1000.0, 298.15))) * Dx_p(c_e_p(t, x_p))) + cache_1468719092292996138_p)) / -0.008035880643729006) + cache_8827340298451170061_p) / cache_5611008514749088974_p
eqs = [
   Dt(c_s_n_xav(t, r_n)) ~ cache_m6477020002439104146,
   Dt(c_s_p_xav(t, r_p)) ~ cache_m6565920499957741508,
   Dt(c_e_n(t, x_n)) ~ cache_9021953732136320602_n,
   Dt(c_e_s(t, x_s)) ~ cache_9021953732136320602_s,
   Dt(c_e_p(t, x_p)) ~ cache_9021953732136320602_p,
]
