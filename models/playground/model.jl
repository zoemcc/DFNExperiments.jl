...
cache_m3178077898352034343 = 8.813457647415216 * (1 / r_n^2 * Dr_n(r_n^2 * Dr_n(c_s_n_xav(t, r_n))))

# 'X-averaged positive particle concentration' equation
cache_6654731712802189039 = 22.598609352346717 * (1 / r_p^2 * Dr_p(r_p^2 * Dr_p(c_s_p_xav(t, r_p))))
...
cache_m3079070087590868177_n = -589429731.3893579
cache_m3079070087590868177_s = -3587155110.512914
cache_m3079070087590868177_p = -589429731.3893579
cache_m2091301940941609524_n = 
   0.1806862603261852 * x_n

cache_m2091301940941609524_s = 
   0.08030500458941565

cache_m2091301940941609524_p = 
   (0.007232292579356106 - (0.007232292579356106 * x_p)) / 0.04002679875215723

cache_m255472911883590737_n = 
   56.212339486148316

cache_m255472911883590737_s = 0.0
cache_m255472911883590737_p = 
   -56.212339486148316

cache_2930882063576453661_n = 0.3
cache_2930882063576453661_s = 1.0
cache_2930882063576453661_p = 0.3
cache_6148810021498622669_n = (((Dx_n(((cache_m3079070087590868177_n * (D_e(c_e_n(t, x_n) * 1000.0, 298.15))) * Dx_n(c_e_n(t, x_n))) + cache_m2091301940941609524_n)) / -0.008035880643729006) + cache_m255472911883590737_n) / cache_2930882063576453661_n
cache_6148810021498622669_s = (((Dx_s(((cache_m3079070087590868177_s * (D_e(c_e_s(t, x_s) * 1000.0, 298.15))) * Dx_s(c_e_s(t, x_s))) + cache_m2091301940941609524_s)) / -0.008035880643729006) + cache_m255472911883590737_s) / cache_2930882063576453661_s
cache_6148810021498622669_p = (((Dx_p(((cache_m3079070087590868177_p * (D_e(c_e_p(t, x_p) * 1000.0, 298.15))) * Dx_p(c_e_p(t, x_p))) + cache_m2091301940941609524_p)) / -0.008035880643729006) + cache_m255472911883590737_p) / cache_2930882063576453661_p
eqs = [
   Dt(c_s_n_xav(t, r_n)) ~ cache_m3178077898352034343,
   Dt(c_s_p_xav(t, r_p)) ~ cache_6654731712802189039,
   Dt(c_e_n(t, x_n)) ~ cache_6148810021498622669_n,
   Dt(c_e_s(t, x_s)) ~ cache_6148810021498622669_s,
   Dt(c_e_p(t, x_p)) ~ cache_6148810021498622669_p,
]
