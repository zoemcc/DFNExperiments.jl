...
cache_m6921983835668977705 = 8.813457647415216 * (1 / r_n^2 * Dr_n(r_n^2 * Dr_n(c_s_n(t, r_n, x_n))))

# 'Positive particle concentration' equation
cache_7864780917422483369 = 22.598609352346717 * (1 / r_p^2 * Dr_p(r_p^2 * Dr_p(c_s_p(t, r_p, x_p))))
...
cache_636416555037631780_n = -589429731.3893579
cache_636416555037631780_s = -3587155110.512914
cache_636416555037631780_p = -589429731.3893579
cache_m1106947310541290080_n = 0.7818002858515763
cache_m1106947310541290080_s = 4.757885022498838
cache_m1106947310541290080_p = 0.7818002858515763
cache_m2543375852233613034_n = 
...
cache_m2543375852233613034_s = 0.0
cache_m2543375852233613034_p = 
...
cache_7932043308953831907_n = 0.3
cache_7932043308953831907_s = 1.0
cache_7932043308953831907_p = 0.3
cache_129758204963177635_n = (((Dx_n(((cache_636416555037631780 * (D_e(cache_m4904596956411893885 * 1000.0, 298.15))) * Dx_n(cache_m4904596956411893885)) + (0.08030500458941565 * (((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_n(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_n(cache_m4905572729113011876)))))) / -0.008035880643729006) + cache_m2543375852233613034) / cache_7932043308953831907
cache_129758204963177635_s = (((Dx_s(((cache_636416555037631780 * (D_e(cache_m4904596956411893885 * 1000.0, 298.15))) * Dx_s(cache_m4904596956411893885)) + (0.08030500458941565 * (((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_s(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_s(cache_m4905572729113011876)))))) / -0.008035880643729006) + cache_m2543375852233613034) / cache_7932043308953831907
cache_129758204963177635_p = (((Dx_p(((cache_636416555037631780 * (D_e(cache_m4904596956411893885 * 1000.0, 298.15))) * Dx_p(cache_m4904596956411893885)) + (0.08030500458941565 * (((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_p(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_p(cache_m4905572729113011876)))))) / -0.008035880643729006) + cache_m2543375852233613034) / cache_7932043308953831907

# 'Negative electrode potential' equation
cache_5379969107169026976 = (-Dx_n(221.12651346369245 * Dx_n(phi_s_n(t, x_n)))) + ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive electrode potential' equation
cache_m5687521129233047772 = (-Dx_p(16.82166381757419 * Dx_p(phi_s_p(t, x_p)))) + ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))

# 'Electrolyte potential' equation
cache_m1106947310541290080_n = 0.7818002858515763
cache_m1106947310541290080_s = 4.757885022498838
cache_m1106947310541290080_p = 0.7818002858515763
cache_6044331350932800067_n = 
...
cache_6044331350932800067_s = 0.0
cache_6044331350932800067_p = 
...
cache_3340670148319538533_n = (Dx_n(((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_n(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_n(cache_m4905572729113011876)))) - cache_6044331350932800067
cache_3340670148319538533_s = (Dx_s(((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_s(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_s(cache_m4905572729113011876)))) - cache_6044331350932800067
cache_3340670148319538533_p = (Dx_p(((kappa_e(cache_m4904596956411893885 * 1000.0, 298.15)) * cache_m1106947310541290080) * (((1.2 * Dx_p(cache_m4904596956411893885)) / cache_m4904596956411893885) - Dx_p(cache_m4905572729113011876)))) - cache_6044331350932800067

eqs = [
   Dt(Q_Ah(t)) ~ 4.27249308415467,
   Dt(c_s_n(t, r_n, x_n)) ~ cache_m6921983835668977705,
   Dt(c_s_p(t, r_p, x_p)) ~ cache_7864780917422483369,
   Dt(c_e_n(t, x_n)) ~ cache_129758204963177635,
   Dt(c_e_s(t, x_s)) ~ cache_129758204963177635,
   Dt(c_e_p(t, x_p)) ~ cache_129758204963177635,
   0 ~ cache_5379969107169026976,
   0 ~ cache_m5687521129233047772,
   0 ~ cache_3340670148319538533,
   0 ~ cache_3340670148319538533,
   0 ~ cache_3340670148319538533,
]

# 'Negative particle concentration' boundary condition
cache_m8369463326209547103 = -0.06303491521497095 * ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive particle concentration' boundary condition
cache_9170318103837215211 = -0.014389780933518372 * ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))
...
ics_bcs = [
   ...
   Dr_n(c_s_n(t, 1.0, x_n)) ~ cache_m8369463326209547103,
   Dr_p(c_s_p(t, 0.0, x_p)) ~ 0.0,
   Dr_p(c_s_p(t, 1.0, x_p)) ~ cache_9170318103837215211,
   phi_s_n(t, 0.0) ~ 0.0,
