...
cache_3704717194950117759 = 8.813457647415216 * (1 / r_n^2 * Dr_n(r_n^2 * Dr_n(c_s_n(t, r_n, x_n))))

# 'Positive particle concentration' equation
cache_m3790799926877610478 = 22.598609352346717 * (1 / r_p^2 * Dr_p(r_p^2 * Dr_p(c_s_p(t, r_p, x_p))))
...
cache_4361795594395375327_n = -589429731.3893579
cache_4361795594395375327_s = -3587155110.512914
cache_4361795594395375327_p = -589429731.3893579
cache_m2588313641038719783_n = 0.7818002858515763
cache_m2588313641038719783_s = 4.757885022498838
cache_m2588313641038719783_p = 0.7818002858515763
cache_m6777181063389034052_n = 
...
cache_m6777181063389034052_s = 0.0
cache_m6777181063389034052_p = 
...
cache_m6698949523043263843_n = 0.3
cache_m6698949523043263843_s = 1.0
cache_m6698949523043263843_p = 0.3
cache_m2115120869325281300_n = (((Dx_n(((cache_4361795594395375327 * (D_e(cache_m7045864823197770475 * 1000.0, 298.15))) * Dx_n(cache_m7045864823197770475)) + (0.08030500458941565 * (((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_n(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_n(cache_5360965038213670820)))))) / -0.008035880643729006) + cache_m6777181063389034052) / cache_m6698949523043263843
cache_m2115120869325281300_s = (((Dx_s(((cache_4361795594395375327 * (D_e(cache_m7045864823197770475 * 1000.0, 298.15))) * Dx_s(cache_m7045864823197770475)) + (0.08030500458941565 * (((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_s(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_s(cache_5360965038213670820)))))) / -0.008035880643729006) + cache_m6777181063389034052) / cache_m6698949523043263843
cache_m2115120869325281300_p = (((Dx_p(((cache_4361795594395375327 * (D_e(cache_m7045864823197770475 * 1000.0, 298.15))) * Dx_p(cache_m7045864823197770475)) + (0.08030500458941565 * (((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_p(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_p(cache_5360965038213670820)))))) / -0.008035880643729006) + cache_m6777181063389034052) / cache_m6698949523043263843

# 'Negative electrode potential' equation
cache_m5202567426538382805 = (-Dx_n(221.12651346369245 * Dx_n(phi_s_n(t, x_n)))) + ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive electrode potential' equation
cache_8658380385753184658 = (-Dx_p(16.82166381757419 * Dx_p(phi_s_p(t, x_p)))) + ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))

# 'Electrolyte potential' equation
cache_m2588313641038719783_n = 0.7818002858515763
cache_m2588313641038719783_s = 4.757885022498838
cache_m2588313641038719783_p = 0.7818002858515763
cache_1742766560872639346_n = 
...
cache_1742766560872639346_s = 0.0
cache_1742766560872639346_p = 
...
cache_4777661441096767105_n = (Dx_n(((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_n(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_n(cache_5360965038213670820)))) - cache_1742766560872639346
cache_4777661441096767105_s = (Dx_s(((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_s(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_s(cache_5360965038213670820)))) - cache_1742766560872639346
cache_4777661441096767105_p = (Dx_p(((\kappa_e(cache_m7045864823197770475 * 1000.0, 298.15)) * cache_m2588313641038719783) * (((1.2 * Dx_p(cache_m7045864823197770475)) / cache_m7045864823197770475) - Dx_p(cache_5360965038213670820)))) - cache_1742766560872639346

eqs = [
   Dt(Q_Ah(t)) ~ 4.27249308415467,
   Dt(c_s_n(t, r_n, x_n)) ~ cache_3704717194950117759,
   Dt(c_s_p(t, r_p, x_p)) ~ cache_m3790799926877610478,
   Dt(c_e_n(t, x_n)) ~ cache_m2115120869325281300,
   Dt(c_e_s(t, x_s)) ~ cache_m2115120869325281300,
   Dt(c_e_p(t, x_p)) ~ cache_m2115120869325281300,
   0 ~ cache_m5202567426538382805,
   0 ~ cache_8658380385753184658,
   0 ~ cache_4777661441096767105,
   0 ~ cache_4777661441096767105,
   0 ~ cache_4777661441096767105,
]

# 'Negative particle concentration' boundary condition
cache_m5647547349592863634 = -0.06303491521497095 * ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive particle concentration' boundary condition
cache_5205104546003641628 = -0.014389780933518372 * ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))
...
ics_bcs = [
   ...
   Dr_n(c_s_n(t, 1.0, x_n)) ~ cache_m5647547349592863634,
   Dr_p(c_s_p(t, 0.0, x_p)) ~ 0.0,
   Dr_p(c_s_p(t, 1.0, x_p)) ~ cache_5205104546003641628,
   phi_s_n(t, 0.0) ~ 0.0,
