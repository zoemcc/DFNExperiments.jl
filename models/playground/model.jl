...
cache_5438655699009697081 = 8.813457647415216 * (1 / r_n^2 * Dr_n(r_n^2 * Dr_n(c_s_n(t, r_n, x_n))))

# 'Positive particle concentration' equation
cache_6614924575618748065 = 22.598609352346717 * (1 / r_p^2 * Dr_p(r_p^2 * Dr_p(c_s_p(t, r_p, x_p))))
...
cache_5878866510612475575_n = -589429731.3893579
cache_5878866510612475575_s = -3587155110.512914
cache_5878866510612475575_p = -589429731.3893579
cache_1819693229883227845_n = 0.7818002858515763
cache_1819693229883227845_s = 4.757885022498838
cache_1819693229883227845_p = 0.7818002858515763
cache_m4661845405154847727_n = 
...
cache_m4661845405154847727_s = 0.0
cache_m4661845405154847727_p = 
...
cache_m6185393496880523698_n = 0.3
cache_m6185393496880523698_s = 1.0
cache_m6185393496880523698_p = 0.3
cache_m7875466999617873204_n = (((Dx_n(((cache_5878866510612475575_n * (D_e(c_e_n(t, x_n) * 1000.0, 298.15))) * Dx_n(c_e_n(t, x_n))) + (0.08030500458941565 * (((kappa_e(c_e_n(t, x_n) * 1000.0, 298.15)) * cache_1819693229883227845_n) * (((1.2 * Dx_n(c_e_n(t, x_n))) / c_e_n(t, x_n)) - Dx_n(phi_e_n(t, x_n))))))) / -0.008035880643729006) + cache_m4661845405154847727_n) / cache_m6185393496880523698_n
cache_m7875466999617873204_s = (((Dx_s(((cache_5878866510612475575_s * (D_e(c_e_s(t, x_s) * 1000.0, 298.15))) * Dx_s(c_e_s(t, x_s))) + (0.08030500458941565 * (((kappa_e(c_e_s(t, x_s) * 1000.0, 298.15)) * cache_1819693229883227845_s) * (((1.2 * Dx_s(c_e_s(t, x_s))) / c_e_s(t, x_s)) - Dx_s(phi_e_s(t, x_s))))))) / -0.008035880643729006) + cache_m4661845405154847727_s) / cache_m6185393496880523698_s
cache_m7875466999617873204_p = (((Dx_p(((cache_5878866510612475575_p * (D_e(c_e_p(t, x_p) * 1000.0, 298.15))) * Dx_p(c_e_p(t, x_p))) + (0.08030500458941565 * (((kappa_e(c_e_p(t, x_p) * 1000.0, 298.15)) * cache_1819693229883227845_p) * (((1.2 * Dx_p(c_e_p(t, x_p))) / c_e_p(t, x_p)) - Dx_p(phi_e_p(t, x_p))))))) / -0.008035880643729006) + cache_m4661845405154847727_p) / cache_m6185393496880523698_p

# 'Negative electrode potential' equation
cache_m7409691414062775130 = (-Dx_n(221.12651346369245 * Dx_n(phi_s_n(t, x_n)))) + ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive electrode potential' equation
cache_976666992706402032 = (-Dx_p(16.82166381757419 * Dx_p(phi_s_p(t, x_p)))) + ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))

# 'Electrolyte potential' equation
cache_1819693229883227845_n = 0.7818002858515763
cache_1819693229883227845_s = 4.757885022498838
cache_1819693229883227845_p = 0.7818002858515763
cache_2819086392837335288_n = 
...
cache_2819086392837335288_s = 0.0
cache_2819086392837335288_p = 
...
cache_m5177415742740341399_n = (Dx_n(((kappa_e(c_e_n(t, x_n) * 1000.0, 298.15)) * cache_1819693229883227845_n) * (((1.2 * Dx_n(c_e_n(t, x_n))) / c_e_n(t, x_n)) - Dx_n(phi_e_n(t, x_n))))) - cache_2819086392837335288_n
cache_m5177415742740341399_s = (Dx_s(((kappa_e(c_e_s(t, x_s) * 1000.0, 298.15)) * cache_1819693229883227845_s) * (((1.2 * Dx_s(c_e_s(t, x_s))) / c_e_s(t, x_s)) - Dx_s(phi_e_s(t, x_s))))) - cache_2819086392837335288_s
cache_m5177415742740341399_p = (Dx_p(((kappa_e(c_e_p(t, x_p) * 1000.0, 298.15)) * cache_1819693229883227845_p) * (((1.2 * Dx_p(c_e_p(t, x_p))) / c_e_p(t, x_p)) - Dx_p(phi_e_p(t, x_p))))) - cache_2819086392837335288_p
eqs = [
   Dt(Q_Ah(t)) ~ 4.27249308415467,
   Dt(c_s_n(t, r_n, x_n)) ~ cache_5438655699009697081,
   Dt(c_s_p(t, r_p, x_p)) ~ cache_6614924575618748065,
   Dt(c_e_n(t, x_n)) ~ cache_m7875466999617873204_n,
   Dt(c_e_s(t, x_s)) ~ cache_m7875466999617873204_s,
   Dt(c_e_p(t, x_p)) ~ cache_m7875466999617873204_p,
   0 ~ cache_m7409691414062775130,
   0 ~ cache_976666992706402032,
   0 ~ cache_m5177415742740341399_n,
   0 ~ cache_m5177415742740341399_s,
   0 ~ cache_m5177415742740341399_p,
]

# 'Negative particle concentration' boundary condition
cache_m7817782435377056859 = -0.06303491521497095 * ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n(t, 1.0, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n(t, 1.0, x_n)) + ((1e-06 * (1.0 / c_s_n(t, 1.0, x_n))) + (1e-06 * (1.0 / (c_s_n(t, 1.0, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive particle concentration' boundary condition
cache_m1480149582134566345 = -0.014389780933518372 * ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p(t, 1.0, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p(t, 1.0, x_p)) + ((1e-06 * (1.0 / c_s_p(t, 1.0, x_p))) + (1e-06 * (1.0 / (c_s_p(t, 1.0, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))
...
ics_bcs = [
   ...
   Dr_n(c_s_n(t, 1.0, x_n)) ~ cache_m7817782435377056859,
   Dr_p(c_s_p(t, 0.0, x_p)) ~ 0.0,
   Dr_p(c_s_p(t, 1.0, x_p)) ~ cache_m1480149582134566345,
   phi_s_n(t, 0.0) ~ 0.0,
