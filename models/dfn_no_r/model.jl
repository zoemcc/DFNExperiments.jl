...
cache_2231435556022763391_s = 0.0
cache_2231435556022763391_p = 
...
cache_m2803132005789240604_n = (((Dx_n(((cache_m8390082798472572148_n * (D_e(c_e_n(t, x_n) * 1000.0, 298.15))) * Dx_n(c_e_n(t, x_n))) + (0.08030500458941565 * (((kappa_e(c_e_n(t, x_n) * 1000.0, 298.15)) * cache_m5258146161584970813_n) * (((1.2 * Dx_n(c_e_n(t, x_n))) / c_e_n(t, x_n)) - Dx_n(phi_e_n(t, x_n))))))) / -0.008035880643729006) + cache_2231435556022763391_n) / cache_m7507122597998692872_n
cache_m2803132005789240604_s = (((Dx_s(((cache_m8390082798472572148_s * (D_e(c_e_s(t, x_s) * 1000.0, 298.15))) * Dx_s(c_e_s(t, x_s))) + (0.08030500458941565 * (((kappa_e(c_e_s(t, x_s) * 1000.0, 298.15)) * cache_m5258146161584970813_s) * (((1.2 * Dx_s(c_e_s(t, x_s))) / c_e_s(t, x_s)) - Dx_s(phi_e_s(t, x_s))))))) / -0.008035880643729006) + cache_2231435556022763391_s) / cache_m7507122597998692872_s
cache_m2803132005789240604_p = (((Dx_p(((cache_m8390082798472572148_p * (D_e(c_e_p(t, x_p) * 1000.0, 298.15))) * Dx_p(c_e_p(t, x_p))) + (0.08030500458941565 * (((kappa_e(c_e_p(t, x_p) * 1000.0, 298.15)) * cache_m5258146161584970813_p) * (((1.2 * Dx_p(c_e_p(t, x_p))) / c_e_p(t, x_p)) - Dx_p(phi_e_p(t, x_p))))))) / -0.008035880643729006) + cache_2231435556022763391_p) / cache_m7507122597998692872_p

# 'Negative electrode potential' equation
cache_6492369250186461943 = (-Dx_n(221.12651346369245 * Dx_n(phi_s_n(t, x_n)))) + ((((2.0 * max(1.0,1e-08)) / 0.5925925925925926) * (j0_n(max(1e-08,c_e_n(t, x_n)) * 1000.0, (max(1e-08,min(c_s_n_rav(t, x_n),0.99999999)) * 24983.2619938437), 298.15))) * (sinh(0.5 * ((phi_s_n(t, x_n) - phi_e_n(t, x_n)) - (((U_n(c_s_n_rav(t, x_n)) + ((1e-06 * (1.0 / c_s_n_rav(t, x_n))) + (1e-06 * (1.0 / (c_s_n_rav(t, x_n) - 1.0))))) - 0.175189434028335) / 0.025692579121493725)))))

# 'Positive electrode potential' equation
cache_m1971717607388808716 = (-Dx_p(16.821663817574187 * Dx_p(phi_s_p(t, x_p)))) + ((((2.0 * max(1.0,1e-08)) * 1.4062500000000002) * (j0_p(max(1e-08,c_e_p(t, x_p)) * 1000.0, (max(1e-08,min(c_s_p_rav(t, x_p),0.99999999)) * 51217.9257309275), 298.15))) * (sinh(0.5 * ((phi_s_p(t, x_p) - phi_e_p(t, x_p)) - (((U_p(c_s_p_rav(t, x_p)) + ((1e-06 * (1.0 / c_s_p_rav(t, x_p))) + (1e-06 * (1.0 / (c_s_p_rav(t, x_p) - 1.0))))) - 4.027013014008729) / 0.025692579121493725)))))

# 'Electrolyte potential' equation
cache_m5258146161584970813_n = 0.7818002858515763
cache_m5258146161584970813_s = 4.757885022498838
cache_m5258146161584970813_p = 0.7818002858515763
cache_4640583059080748710_n = 
...
cache_4640583059080748710_s = 0.0
cache_4640583059080748710_p = 
...
cache_m602888930472315608_n = (Dx_n(((kappa_e(c_e_n(t, x_n) * 1000.0, 298.15)) * cache_m5258146161584970813_n) * (((1.2 * Dx_n(c_e_n(t, x_n))) / c_e_n(t, x_n)) - Dx_n(phi_e_n(t, x_n))))) - cache_4640583059080748710_n
cache_m602888930472315608_s = (Dx_s(((kappa_e(c_e_s(t, x_s) * 1000.0, 298.15)) * cache_m5258146161584970813_s) * (((1.2 * Dx_s(c_e_s(t, x_s))) / c_e_s(t, x_s)) - Dx_s(phi_e_s(t, x_s))))) - cache_4640583059080748710_s
cache_m602888930472315608_p = (Dx_p(((kappa_e(c_e_p(t, x_p) * 1000.0, 298.15)) * cache_m5258146161584970813_p) * (((1.2 * Dx_p(c_e_p(t, x_p))) / c_e_p(t, x_p)) - Dx_p(phi_e_p(t, x_p))))) - cache_4640583059080748710_p
eqs = [
   Dt(c_s_n_rav(t, x_n)) ~ cache_901923982499610471,
   Dt(c_s_p_rav(t, x_p)) ~ cache_m5364182416041923453,
   Dt(c_e_n(t, x_n)) ~ cache_m2803132005789240604_n,
   Dt(c_e_s(t, x_s)) ~ cache_m2803132005789240604_s,
   Dt(c_e_p(t, x_p)) ~ cache_m2803132005789240604_p,
   0 ~ cache_6492369250186461943,
   0 ~ cache_m1971717607388808716,
   0 ~ cache_m602888930472315608_n,
   0 ~ cache_m602888930472315608_s,
   0 ~ cache_m602888930472315608_p,
]
